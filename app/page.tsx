...
function Home() {
  ...
  async function updateUserData() {
    ...
    if (greenProfitPerClick > 0) {
      click_count = Math.ceil((green - firstGreenValue) / greenProfitPerClick);
    } else if (goldProfitPerClick > 0) {
      click_count = Math.ceil((gold - firstGoldValue) / goldProfitPerClick);
    }
  ...
  const coinTaped = (e: any) => {
    if (energy >= 1 && (greenProfitPerClick > 0 || goldProfitPerClick > 0)) {
